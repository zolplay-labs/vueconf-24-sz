<template>
  <section class="my-12 h-[30vh] md:h-[40vh] px-4 md:px-0 flex flex-col justify-center items-center max-w-3xl mx-auto grid grid-cols-4 grid-rows-2">
    <header class="col-[1/5] row-[1/2] h-full flex justify-center items-center border border-dashed border-zinc-200/10 border-b-0">
